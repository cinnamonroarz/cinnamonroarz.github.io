## Abstract Algebra by Dummit & Foote | Chapter 14 Day 1 | 14.1
...
**Solution.** Clearly $\tau$ is a map from $\mathbb C$ to $\mathbb C$ and $\tau((a+bi)+(c+di))=\tau((a+c)+(b+d)i)=(a+b)-(c+d)i=\tau(a+bi)+\tau(c+di)$ and
```math
